/*************************************************************************
    ...
    > Created Time: 2016年10月06日 星期三 23时14分13秒
    > For : 根据 http://www.derekmolloy.ie/ 网站上的代码解决编译告警和模块不能卸载问题
 ************************************************************************/
...
#include <linux/list.h>           // list head  list_for_each_entry
...
static int __init ebbchar_init(void){
    ...
    {
        if(strcmp(pmod->name,DEVICE_NAME ) ==0)
        {
            // set the state to zero ,or you may can not 'rm ebbchar'
            pmod->state =0;
        }
    }
